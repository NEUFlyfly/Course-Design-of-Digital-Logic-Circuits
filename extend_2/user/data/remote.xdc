...
# 状态指示灯 - 使用LED显示状态
set_property -dict {PACKAGE_PIN B22 IOSTANDARD LVCMOS33} [get_ports {state[0]}]
set_property -dict {PACKAGE_PIN C23 IOSTANDARD LVCMOS33} [get_ports {state[1]}]
set_property -dict {PACKAGE_PIN A23 IOSTANDARD LVCMOS33} [get_ports {state[2]}]
...
# 系统状态指示灯
set_property -dict {PACKAGE_PIN D21 IOSTANDARD LVCMOS33} [get_ports leds]
