...
synth_design -top traffic_LCD -part xc7a200tfbg676-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef traffic_LCD.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file traffic_LCD_utilization_synth.rpt -pb traffic_LCD_utilization_synth.pb"
